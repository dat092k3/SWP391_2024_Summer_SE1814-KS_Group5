                            ...
                            <div class="variants_selects">
                                ...
                                <div class="modal_add_to_cart">
                                    <form>
                                        ...
                                        <button onclick="loadProductCart(this)" type="button">Thêm vào giỏ hàng</button>
                                    </form>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-lg-7 col-md-7 col-sm-12">
                                <div class="modal_add_to_cart">
                                    <div style="display: flex;">
                                        ...
                                        <div>
                                            <h4>Số dư trong ví:</h4>
                                            <h3 style="color: green">$ ${balance}</h3>
                                        </div>
                                    <form action="wallet" method="get">
                                        <input  name="add" type="text" min="50" max="10000" step="5" value="25">
                                        <p style="color: grey">Nhập số tiền tối thiểu là $50 và tối đa là $10000</p>
                                        <input  name="userN" type="hidden" value="${name}">
                                        <button type="submit">Thêm vào ví</button>
                                    </form>
                                </div>
                            </div>
                        </div>
    ...
    <div class="modal-content" style="width:500px; margin: 0 auto">
      ...
      <div class="modal-body" style="font-size: 16px; font-weight: 600; color: red" >Bạn có chắc chắn muốn đăng xuất tài khoản của mình ?</div>
        <div class="modal-footer" style="justify-content: center;">
            ...
            <div style="width:40%"><button data-dismiss="modal" aria-label="close" class="btn btn-primary btn-block">Hủy</button></div>
        </div>
    </div>
</div>`;
                ...
                <div class="modal-content">
                    <form id="form" action="addbalance" method="post">
                        <div class="modal-header">						
                            <h4 class="modal-title">Thêm vào ví</h4>
                        </div>
                        ...
                        <div class="modal-footer">
                            ...
                            <input type="submit" onclick="submitForm()" class="btn btn-success" value="Thêm">
                        </div>
                    </form>
                </div>
            </div>`;
