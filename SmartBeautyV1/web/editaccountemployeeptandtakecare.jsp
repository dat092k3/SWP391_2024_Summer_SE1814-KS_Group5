                ...
                <div class="py-2">
                    ...
                    <div class="row py-2">
                        ...
                        <div class="col-md-6 pt-md-0 pt-3">
                            ...
                            <input type="text" class="bg-light form-control"  value="${accountbyid.password}" name="password" minlength="3" maxlength="50" required="">
                            <span style="color: red">${error4}</span>
                        </div>
                    </div>
                    <div class="row py-2">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="bg-light form-control"  value="${accountbyid.email}" name="email" maxlength="255" pattern="^\S.*$"  title="cannot contain any spaces." required="">
