<%-- 
    Document   : statistics
    Created on : Jul 7, 2024, 9:41:22 AM
    Author     : LENOVO
--%>
            ...
            <div id="sidebar-wrapper" data-simplebar="" data-simplebar-auto-hide="true">
                <div class="brand-logo">
                    <a href="index.jsp">
                        ...
                        <h5 class="logo-text">Statistics</h5>
                    </a>
                </div>
                            ...
                            <div class="card">
                                    ...
                                    <div class="card-action">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                ...
                                                <a class="dropdown-item" href="javascript:void();">PT</a>
                                                <a class="dropdown-item" href="javascript:void();">Take care</a>
                                                <a class="dropdown-item" href="javascript:void();">Manager</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <div class="chart-container-2">
                                        <canvas id="chartemployee" width="467" height="180"></canvas>
                                    </div>
                                </div>
