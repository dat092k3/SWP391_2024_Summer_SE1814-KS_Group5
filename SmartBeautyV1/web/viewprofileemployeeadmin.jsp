...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>View Profile Employee Admin</title>
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-4 order-lg-1 order-2">
                            <div class="d-flex align-items-center justify-content-around m-4">
                                ...
                                <div class="text-center">
                                    <button class="btn btn-primary"><a href="viewaccountadmin" style="color: white">Account Admin</a></button>
                                </div>                              
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="get" action="addprofileemployeeemptyadmin">
                            <div class="row">
                                <div class="col-xl-4">
