                                ...
                                <div class="col-md-5 border-right">
                                    <div class="p-3 py-5">
                                        ...
                                        <div class="row mt-3">
                                            ...
                                            <div class="col-md-12"><label class="labels">Email</label><input type="email" pattern="^\S.*$"  title="cannot contain any spaces." class="form-control" name="email" placeholder="Enter Email" value="${p.email}" required=""></div>
                                            <div class="col-md-12"><label class="labels">Phone Number</label><input type="text" class="form-control" name="phonenumber" placeholder="Phone Number" required pattern="^\d{10}$" title="Phone number must start with 0 and be 10 digits long."value="${p.phoneNumber}" ></div>
                                            <div class="col-md-12"><label class="labels">Date of Birth</label><input type="date" pattern="^\S.*$" title="cannot contain any spaces." class="form-control" name="dateofbirth" placeholder="Enter Date Of Birth" value="${p.dateOfBirth}" ></div>
                                                <c:if test="${not empty error}">
                                                <div style="color: red;">
                                                    <c:out value="${error}"/>
                                                </div>
        ...
        <form action="updateprofileemployee" method="get">
            <c:if test="${not empty e}">
                <div class="container rounded bg-white mt-5 mb-5">
                    <div class="row">
                        <div class="col-md-3 border-right">
                            <div class="d-flex flex-column align-items-center text-center p-3 py-5"><img class="rounded-circle mt-5" width="150px" src="${e.image}"><span class="font-weight-bold">${e.fullName}</span><span class="text-black-50">${p.email}</span><span> </span></div>
                        </div>
                        <div class="col-md-5 border-right">
                            <div class="p-3 py-5">
                                <div class="d-flex justify-content-between align-items-center mb-3">
