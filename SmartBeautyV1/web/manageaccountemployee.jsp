...
<html>
    <head>
        ...
        <script src="styles/bootstrap-4.1.2/bootstrap.min.css" rel="stylesheet" id="bootstrap-css"></script>
        ...
        <link href="styles/manageaccount.css" rel="stylesheet" type="text/css"/> 
    ...
    <body>
        ...
        <!--Main Navigation-->
        <header>
            <jsp:include page="include/leftadmin.jsp"></jsp:include>
            </header>
            <!--Main Navigation-->
            <jsp:include page="include/header_right.jsp"></jsp:include>
            <!--Main layout-->
            <main>
