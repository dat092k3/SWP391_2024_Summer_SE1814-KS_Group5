                                    ...
                                    <div class="card mb-4">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control"  type="text" placeholder="Enter Full Name" name="fullname" value="${profilebyaccountid.fullName}" required="">
                                            ...
                                            <div class="row gx-3 mb-3">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input class="form-control" type="email" name="email" placeholder="Enter Email" value="${profilebyaccountid.email}" required="">
