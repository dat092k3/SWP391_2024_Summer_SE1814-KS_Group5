 ...
 * @author admin
 */
public class AddProfileEmployeeOfManagerEmptyServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet AddProfileEmployeeOfManagerEmptyServlet</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet AddProfileEmployeeOfManagerEmptyServlet at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (fullname.isEmpty() || !fullname.matches("^[A-ZÀ-Ỵ][a-zà-ỹ]+( [A-ZÀ-Ỵ][a-zà-ỹ]+)+")) {
            ...
            request.getRequestDispatcher("viewprofileemployee").forward(request, response);
            ...
            request.getRequestDispatcher("viewprofileemployeep").forward(request, response);
