...
public class UpdateReportServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        managerDAO.updateReport(Integer.parseInt(reportId));
        List<Report> list= managerDAO.getAllReport();
        request.setAttribute("message", "Update Successful");
        request.setAttribute("listReport", list);
        request.setAttribute("showEditDialog", false);
        request.getRequestDispatcher("./managereport.jsp").include(request, response);
    } 
